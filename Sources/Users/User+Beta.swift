...
extension User {
    public struct Beta: Sendable, Decodable {
...
extension User.Beta {
    public struct Identity: Sendable, Decodable {
...
// MARK: - CloudRealtimeCommunicationInfo
...
// MARK: - OnPremisesExtensionAttributes
...
// MARK: - OnPremisesProvisioningError
